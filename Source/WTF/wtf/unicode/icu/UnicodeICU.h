...
inline int toLower(UChar* result, int resultLength, const UChar* src, int srcLength, const char* locale, bool* error)
{
    UErrorCode status = U_ZERO_ERROR;
    int realLength = u_strToLower(result, resultLength, src, srcLength, locale, &status);
...
inline int toUpper(UChar* result, int resultLength, const UChar* src, int srcLength, const char* locale, bool* error)
{
    UErrorCode status = U_ZERO_ERROR;
    int realLength = u_strToUpper(result, resultLength, src, srcLength, locale, &status);
    *error = !!U_FAILURE(status);
    return realLength;
}
